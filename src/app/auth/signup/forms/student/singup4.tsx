  ...
  return (
    <div className="flex items-center justify-center flex-col mt-2">
      <section className="max-w-2xl mx-auto bg-white">
        <div className="h-[120px] bg-[#365CCE] w-full text-white flex items-center justify-center flex-col gap-5">
          ...
          <div className="flex flex-col gap-3">
            <div className="text-xl sm:text-3xl tracking-wider font-bold capitalize">
              Verify your E-mail Address (todo)
            </div>
          </div>
        </div>
